...
select lower(concat_ws(' ',first_name,last_name)) from customer c where (first_name = 'KELLY' or first_name = 'WILLIE') and activebool = true;
...
from customer c ; -- Здесь пишутся слова с большой буквы после точки.
select 
...
from customer c; -- Здесь представлен правильный код, но он довольно объемный.